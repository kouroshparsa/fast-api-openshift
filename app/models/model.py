...
class Payment(Base):
    ...
    payment_id = Column(Integer, primary_key=True, server_default=text("nextval('language_language_id_seq'::regclass)"))
    ...
    rental_id = Column(ForeignKey('rental.rental_id', ondelete='RESTRICT', onupdate='CASCADE'), nullable=False, index=True)
